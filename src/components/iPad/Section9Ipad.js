...
import '../../styles/iPad/section9Ipad.css';
...
class Section9Ipad extends Component {
    ...
    render() {
        ...
        return (
            <div className="App">
                <Container>
                    <Grid item xs={12} sm={12} md={8} className="centerFooter-ipad" id="getInTouch">
                        <Grid item xs={12} sm={12} md={12}>
                            <Grid container className="get-in-touch-form-ipad">
                                <Grid item xs={12} sm={12} md={12} className="get-in-touch-form-ipad">
                                    <Container>
                                        <Grid container>
                                            <Grid item xs={12} sm={12} md={9}>
                                                <Typography variant="h4" className="mvp-talk-mob-ipad">
                                                    Let’s Talk.
                                                </Typography>
                                            {/*</Grid>*/}
                                            {/*<Grid item xs={12} sm={12} md={4}>*/}
                                                <Typography variant="h4" className="mvp-email-mob-ipad">
                                                    Hey@disruptem.com
                                                </Typography>
                                            </Grid>
                                        </Grid>
                                            ...
                                            <form noValidate autoComplete="off" onSubmit={this.handleSubmit.bind(this)} method="POST">
                                                ...
                                                <div>
                                                    <Button variant="outlined" color="primary"
                                                            className="callMeBackButton-ipad" type="submit" style={{backgroundColor: this.state.bgColor ,border: this.state.btBorder}}>
                                                        <img src={phoneIcon} alt="" className="phoneIconImage-ipad"/> &nbsp; CALL ME
                                                        BACK
                                                    </Button>
                                                </div>
                                            </form>
