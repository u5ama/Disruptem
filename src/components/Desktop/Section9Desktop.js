...
import '../../styles/Desktop/section9Desktop.css';
...
class Section9Desktop extends Component {
    ...
    render() {
        if (this.state.isSuccess) {
            return <Redirect to = {{ pathname: "/",state: { name: this.state.name, email: this.state.email, mobile_no: this.state.mobile_no, message:this.state.message } }} />;
        }
        return (
            <div className="App">
                <Container>
                    <Grid item xs={12} sm={12} md={12} className="centerFooter-desktop" id="getInTouch">
                        <Grid item xs={12} sm={12} md={12}>
                            <Grid container className="get-in-touch-form-desktop">
                                <Grid item xs={12} sm={12} md={12} className="get-in-touch-form-desktop">
                                    <Container>
                                        <Grid container>
                                            <Grid item xs={12} sm={12} md={9}>
                                                <Typography variant="h4" className="mvp-talk-mob-desktop">
                                                    Let’s Talk.
                                                </Typography>
                                            {/*</Grid>*/}
                                            {/*<Grid item xs={12} sm={12} md={4}>*/}
                                                <Typography variant="h4" className="mvp-email-mob-desktop">
                                                    Hey@disruptem.com
                                                </Typography>
                                            </Grid>
                                        </Grid>
                                            ...
                                            <form noValidate autoComplete="off" onSubmit={this.handleSubmit.bind(this)} method="POST">
                                                ...
                                                <div>
                                                    <Button variant="outlined" color="primary"
                                                            className="callMeBackButton-desktop" type="submit" style={{backgroundColor: this.state.bgColor ,border: this.state.btBorder}}>
                                                        <img src={phoneIcon} alt="" className="phoneIconImage-desktop"/> &nbsp; CALL ME
                                                        BACK
                                                    </Button>
                                                </div>
                                            </form>
...
export default Section9Desktop;